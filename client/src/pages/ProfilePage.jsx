...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-n0-repeat flex items-center justify-center'>
      ...
      border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <textarea onChange={(e) => setBio(e.target.value)} value={bio} required placeholder='Write profile bio' className='p-2 border border-grey-500 rounded-md focus:outline-none focus:ring-2 focus:ring-violet-500 ' rows={4}></textarea>
